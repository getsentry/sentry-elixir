defmodule Sentry.ClientTest do
  ...
  test "authorization" do
    ...
    assert Client.authorization_header(public_key, private_key) =~ ~r/Sentry sentry_version=5, sentry_client=sentry-elixir\/0.0.5, sentry_timestamp=\d{10}, sentry_key=public, sentry_secret=secret/
  end
