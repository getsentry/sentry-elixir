defmodule Sentry.EventTest do
  ...
  test "parses error exception" do
    ...
    assert %{
      frames: [
        %{filename: "lib/ex_unit/runner.ex", function: "anonymous fn/3 in ExUnit.Runner.spawn_test/3", lineno: _, module: ExUnit.Runner, context_line: nil, post_context: [], pre_context: [], in_app: false, vars: %{}},
        %{filename: "timer.erl", function: ":timer.tc/1", lineno: _, module: :timer, context_line: nil, post_context: [], pre_context: [], in_app: false, vars: %{}},
        %{filename: "lib/ex_unit/runner.ex", function: "ExUnit.Runner.exec_test/1", lineno: _, module: ExUnit.Runner, context_line: nil, post_context: [], pre_context: [], in_app: false, vars: %{}},
