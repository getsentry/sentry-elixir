defmodule Sentry.Metrics do
  ...
  Once enabled, a supervised collector reports these gauges every 30 seconds by default:
  ...
  version. See the `:metrics` option in the `Sentry` module documentation for the
  full configuration.
