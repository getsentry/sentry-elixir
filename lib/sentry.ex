defmodule Sentry do
  ...
  def send_event(event = %Event{}) do
    included_environments = Application.get_env(:sentry, :included_environments, ~w(prod test dev)a)
    environment_name = Application.get_env(:sentry, :environment_name, :dev)
