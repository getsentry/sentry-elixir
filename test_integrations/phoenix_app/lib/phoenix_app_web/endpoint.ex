# This file is used to test the Phoenix integration, it has to be here
# instead of in test/fixtures/phoenix_app because phoenix_app cannot
# have a dependency on sentry as sentry depends on phoenix_app.
defmodule PhoenixAppWeb.Endpoint do
  ...
  # CORS handling for e2e tests (Svelte frontend on port 4001 -> Phoenix on port 4000)
  plug :cors
